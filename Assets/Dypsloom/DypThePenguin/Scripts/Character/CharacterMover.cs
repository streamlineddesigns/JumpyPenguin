    ...
    public class CharacterMover : ICharacterMover
    {
        ...
        public void Tick()
        {
            ...
            var movementInput = m_Character.IsDead
                ? Vector3.zero
                : new Vector3(m_Character.CharacterInput.Horizontal, 0, 0);

            var movementRelativeCamera = m_Character.CharacterCamera.transform.TransformDirection(movementInput);
            movementRelativeCamera = new Vector3(movementRelativeCamera.x, 0, movementRelativeCamera.z);
            ...
            /*if (! GameController.Instance.isGameActive) {
                m_Movement = externalMovement + m_GravityMovement;
            } else {
